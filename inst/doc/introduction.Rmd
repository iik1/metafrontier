...
bootstrap confidence intervals for the technology gap ratio. The
nonparametric bootstrap resamples DMUs within each group, so a column
of the bootstrap matrix is a resampled unit rather than a fixed DMU; it
reports intervals for the group mean and median TGR only. The
parametric bootstrap keeps the design fixed and also reports
